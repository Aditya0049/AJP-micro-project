...
public class Project extends JFrame implements ActionListener {  
    ...
    {  
        ...
        nl=new JLabel("20IF229, 20IF238, 20IF245, 20IF243, 20IF218");  
    ...
    public void actionPerformed(ActionEvent e){  
		...
		fmsg = msg+"Total: "+amount;
        JOptionPane.showMessageDialog(this,fmsg);
    ...
    public static void main(String[] args) throws Exception { 
		...
		byte b[] = "Welcome to our Restraurant".getBytes();
		out.write(b);
		s.close();
    }  
}  
